...
<html>
    ...
    <body>
        <div id="wrap">
            ...
            <div class="form">
                <form name="userInfo" method="post" action="signupInsert.jsp" onsubmit="return checkValue()">
                    <table>
                        <tr>
                            <td>아이디*</td>
                            <td><input type="text" name="user_id">
                            	<input type="button" value="중복확인" onclick="return idDulplicateChk()">  
                            </td>
                        </tr>
                        <tr>
                            <td>비밀번호*</td>
